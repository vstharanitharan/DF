...
- **Module 1: Interactive Reasoning Effort Slider & Maze Explorer**: Allows the learner to adjust reasoning effort $K \in [1, 20]$ or click "+ / − Effort" or "Auto" to observe predicted latent probability trails evolving step-by-step alongside the optimal BFS baseline.
...
| **BDH-CQ Table 5 Data** | `[PRECOMPUTED / EXTERNAL]` | Direct reproduction of published experimental data from Pathway (arXiv:2608.09888, Table 5) on the ARC-AGI-1 benchmark. Not generated by local code. |
...
- **Codebase License**: Apache-2.0 License (see [LICENSE](file:///c:/Users/toshr/OneDrive/Documents/ChatGPT/DataForge/LICENSE)).
